...
const COLOR_MAP = {
  orange: {
    iconBg: 'linear-gradient(135deg,var(--accent),var(--accent))',
...
export default function StatCard({
  ...
  return (
    <div
      className="group relative bg-[var(--card)] rounded-2xl p-5 border overflow-hidden animate-fade-in-up hover:shadow-[var(--shadow-glow-navy)] transition-all duration-300 cursor-default"
      style={{
      ...
      <div className="relative flex items-start justify-between mb-4">
        ...
        {change && (
          <div className="flex items-center gap-1 px-2 py-1 rounded-lg text-xs font-semibold"
            style={{
              background: changeDir === 'up' ? 'rgba(34,197,94,0.15)' : changeDir === 'down' ? 'rgba(239,68,68,0.15)' : 'var(--bg)',
