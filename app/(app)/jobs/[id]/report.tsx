  ...
  return (
    <View style={s.screen}>
      ...
      <View style={s.content}>
        <MaterialCommunityIcons name="file-document-outline" size={64} color={Colors.light.border} />
        <Text style={s.title}>Report Generation</Text>
        <Text style={s.sub}>Coming in Phase 9</Text>
      </View>
    </View>
  );
}
