...
const STATUS_MAP: Record<string, { label: string; bg: string; color: string; dot?: string }> = {
  ...
  in_progress:  { label: 'In Progress',  bg: 'rgba(232,101,10,0.15)', color: '#fb923c', dot: 'var(--accent)' },
  ...
  major:        { label: 'Major',        bg: 'rgba(232,101,10,0.15)', color: '#fb923c', dot: 'var(--accent)' },
  ...
  overdue:       { label: 'Overdue',      bg: 'rgba(232,101,10,0.15)', color: '#fb923c', dot: 'var(--accent)' },
  ...
  suspended:     { label: 'Suspended',    bg: 'rgba(239,68,68,0.15)', color: '#f87171', dot: '#ef4444' },
  // Priority
  urgent:        { label: 'Urgent',       bg: 'rgba(239,68,68,0.15)', color: '#f87171', dot: '#ef4444' },
  high:          { label: 'High',         bg: 'rgba(232,101,10,0.15)', color: '#fb923c', dot: 'var(--accent)' },
  ...
  contacted:     { label: 'Contacted',    bg: 'rgba(232,101,10,0.15)', color: '#fb923c', dot: 'var(--accent)' },
