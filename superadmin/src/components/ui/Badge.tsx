...
const STATUS_MAP: Record<string, { label: string; bg: string; color: string; dot?: string }> = {
  ...
  in_progress:  { label: 'In Progress',  bg: 'rgba(249,115,22,0.15)', color: '#fb923c', dot: 'var(--accent)' },
  ...
  major:        { label: 'Major',        bg: 'rgba(249,115,22,0.15)', color: '#fb923c', dot: 'var(--accent)' },
  ...
  overdue:       { label: 'Overdue',      bg: 'rgba(249,115,22,0.15)', color: '#fb923c', dot: 'var(--accent)' },
  ...
  high:          { label: 'High',         bg: 'rgba(249,115,22,0.15)', color: '#fb923c', dot: 'var(--accent)' },
  ...
  contacted:     { label: 'Contacted',    bg: 'rgba(249,115,22,0.15)', color: '#fb923c', dot: 'var(--accent)' },
